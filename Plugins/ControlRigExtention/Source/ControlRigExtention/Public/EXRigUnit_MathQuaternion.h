 ...
 */
USTRUCT(meta = (DisplayName = "From Vector", PrototypeName = "FromVector", Keywords = "Make,Construct"))
struct CONTROLRIGEXTENTION_API FEXRigUnit_MathQuaternionFromVector : public FEXRigUnit_MathQuaternionBase
{
	GENERATED_BODY()

	FEXRigUnit_MathQuaternionFromVector()
	{
